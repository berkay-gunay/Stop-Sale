                        ...
                        <div class='card-body'>
                            ...
                            <div class='card-body'>
                                <table class='table table-bordered table-striped'>
                                    <?php
                                    $sql = "SELECT DISTINCT s.id, c.contract_name, h.name, s.from_date, s.to_date,s.monday,s.tuesday,s.wednesday,s.thursday,s.friday,s.saturday,s.sunday,s.contract_id FROM nis_stop_sale s
                            ...
                            if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_id'])) {
                                ...
                                $deleteSql = "DELETE FROM nis_stop_sale WHERE id = ?";
